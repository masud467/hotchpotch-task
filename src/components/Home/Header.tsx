...
export default function Header() {
  return (
    <div className='text-white text-center flex flex-col justify-center items-center     mt-16'>
      <div className='md:w-[500px] h-[450px] space-y-7'>
  ...
  >
      ...
      <p className='text-xl font-semibold'>Artificial intelligence writing tool helps you create blogs, social media websites and much more.</p>
